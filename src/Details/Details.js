...
class Details extends Component {
    ...
    componentDidMount() {
        ...
        fetch(`http://empresas.ioasys.com.br/api/v1/enterprises/${this.props.match.params.id}`, {
            ...
            .catch(err => {
                this.setState({ companyInfo: 'Desculpe, houve um problema com a busca das informações. Tente mais tarde' })
            })
    }
        ...
        return (
            <div>
                ...
                <div className="card mb-3" id="infocard">
                    <img src={this.state.photo} className="card-img-top mx-auto d-block" alt="imagem da empresa" id="companyPhoto" />
